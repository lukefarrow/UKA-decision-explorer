...
function render(){
 ...
 <article class="outcome-card"><div class="eyebrow dark">Pain & function</div><h3>Oxford Knee Score</h3><div class="compare">${metric('UKA prognostic reference',uO.toFixed(1),'~6 months; reconstructed estimate')}${metric('TKR prognostic reference',tO.toFixed(1),'12 months; reduced reference-profile estimate')}</div><div class="delta">Randomized comparative effect: +3.5 OKS points favouring UKA (95% CI 2.3–4.7), below the conventional 4–5 point MCID.</div><div class="outcome-copy">The two prognostic values come from different source models and follow-up times and must not be subtracted to infer a treatment effect. The randomized comparison is therefore shown separately.</div>${evidence('Recent randomized evidence reports at most a modest conventional PROM difference, while TOPKAT found no clinically important mean OKS difference at long-term follow-up.',[{pmid:41662451,label:'2026 blinded multicentre RCT'},{pmid:41270774,label:'TOPKAT 10-year randomized comparison'},{pmid:25042552,label:'Large UKA PROM prediction cohort'},{pmid:29467465,label:'Externally validated TKR OKS prediction model'}])}</article>
