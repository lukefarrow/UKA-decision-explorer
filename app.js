...
function renderMedial(x){
 ...
 <article class="outcome-card"><div class="eyebrow dark">Pain & function · medial UKA</div><h3>Oxford Knee Score at 12 months</h3><div class="compare">${metric('Medial UKA','41.2','95% CI 39.6–42.7; randomized trial')}${metric('TKR','38.4','95% CI 36.9–40.0; randomized trial')}</div><div class="delta">Adjusted improvement difference: +3.2 OKS points favouring medial UKA (95% CI 0.9–5.6).</div><div class="outcome-copy">Matched-timeframe randomized evidence is used as the primary comparison. Patient-specific OKS prediction is not claimed.</div>${evidence('A blinded randomized comparison in isolated medial osteoarthritis provides the matched 12-month comparison; longer-term randomized evidence shows little conventional PROM separation.',[{pmid:41662451,label:'2026 blinded multicentre medial UKA vs TKA RCT'},{pmid:41270774,label:'TOPKAT 10-year comparison'}])}</article>
